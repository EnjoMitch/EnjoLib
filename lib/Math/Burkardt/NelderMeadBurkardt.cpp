...
#include "NelderMeadBurkardt.hpp"
#include "../Opti/OptiMultiSubject.hpp"

using namespace std;
using namespace NelderMeadBurkardt;
...
void NelderMeadBurkardt::timestamp ( void )
